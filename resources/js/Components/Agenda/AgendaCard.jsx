const AgendaCard = ({ date, title, description }) => {
    return (
        <div className="flex max-w-sm cursor-pointer items-center gap-4 overflow-hidden rounded-md border border-gray-200 bg-white shadow-md transition hover:border-primary hover:shadow-lg">
            {/* Date Section */}
